...
int main(){
    ...
    string ua;
    for (i = 0; i < 10; i++){
        cpputils::HttpClientUtils::genRandomPCUserAgent(ua);
        cout << "PC-User-Agent=" << ua << endl;
        ua.clear();
    }
    for (i = 0; i < 10; i++){
        cpputils::HttpClientUtils::genRandomMobileUserAgent(ua);
    ...
    if (cpputils::SomeUtils::isFileExist(tmpFilePath)){
    ...
    cout << "httpRequest::GET=" << cpputils::httpRequest::GET << endl;
    cout << "httpRequest::POST=" << cpputils::httpRequest::POST << endl;
    cout << "httpRequest::PUT=" << cpputils::httpRequest::PUT << endl;
    cout << "httpRequest::HEAD=" << cpputils::httpRequest::HEAD << endl;
    cout << "httpRequest::DELETE=" << cpputils::httpRequest::DELETE << endl;
    cout << endl;
